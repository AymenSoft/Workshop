package com.aymen.movies.modules.splashScreen.userInterface.view
...
import com.aymen.movies.databinding.ActivitySplashScreenBinding
import com.aymen.movies.modules.moviesList.userInterface.view.MoviesListActivity
import com.aymen.movies.modules.networkIssue.userInterface.view.NoInternetConnexionPopupActivity
import com.aymen.movies.utils.GOOGLE_URL
            ...
            override fun run() {
                try {
                    ...
                    if (!isPaused && isConnected()){
                        startActivity(Intent(this@SplashScreenActivity, MoviesListActivity::class.java))
                        finish()
                    }
                } catch (e: Exception) {
                    e.printStackTrace()
